...
function compareFieldNames(a, b) {
  var aOrder = nameOrder(a);
  var bOrder = nameOrder(b);
  if (aOrder < bOrder) {
    return -1;
  }
  if (aOrder > bOrder) {
...
var printDocASTReducer = {
  ...
  OperationDefinition: function OperationDefinition(node) {
    ...
    var name = node.name;
    var varDefs = wrap('(', join(node.variableDefinitions && node.variableDefinitions.slice().sort(), ','), ')');
  ...
  SelectionSet: function SelectionSet(_ref2) {
    ...
    return block(selections && selections.slice().sort(compareFieldNames));
  },
  ...
  Field: function Field(_ref3) {
    ...
    return join([
    /* wrap('', alias, ':') + */name + wrap('(', join(args && args.slice().sort(), ', '), ')'), join(directives, ' '), selectionSet], ' ');
  },
  ...
  FragmentSpread: function FragmentSpread(_ref5) {
    ...
    return '...' + name + wrap(' ', join(directives && directives.slice().sort(), ' '));
  },
  ...
  InlineFragment: function InlineFragment(_ref6) {
    ...
    return join(['...', wrap('on ', typeCondition), join(directives && directives.slice().sort(), ' '), selectionSet], ' ');
  },
  ...
  FragmentDefinition: function FragmentDefinition(_ref7) {
    ...
    return "fragment " + name + " on " + typeCondition + " " + wrap('', join(directives && directives.slice().sort(), ' '), ' ') + selectionSet;
  },
  ...
  Directive: function Directive(_ref16) {
    ...
    return '@' + name + wrap('(', join(args && args.slice().sort(), ','), ')');
  },
