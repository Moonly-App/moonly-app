import { Components, registerComponent, withMessages, replaceComponent, getRawComponent, apolloClient, Utils, getSetting } from 'meteor/vulcan:core';
    ...
    return (
      <div className={this.getActionClass()}>
        <a className="upvote-button" onClick={this.upvote}>
          {this.state.loading ? <Components.Icon name="spinner" /> : <Components.Icon name="heart-o" /> }
...
registerComponent('Vote', CustomVote, withMessages, withVote);
