...
import { Components, registerComponent, getFragment, withMessages, replaceComponent } from 'meteor/vulcan:core';
import { Categories } from 'meteor/example-forum';

const CustomCategoriesEditForm = (props, context) => {
  
  return (
    <div className="categories-edit-form">
      <div className="categories-edit-form-admin">
        <div className="categories-edit-form-id"></div>
      </div>
...
CustomCategoriesEditForm.propTypes = {
  category: PropTypes.object.isRequired,
  closeModal: PropTypes.func,
  flash: PropTypes.func,
};

CustomCategoriesEditForm.contextTypes = {
  intl: intlShape,
};

replaceComponent('CategoriesEditForm', CustomCategoriesEditForm, withMessages);
