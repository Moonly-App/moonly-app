import { Components, replaceComponent, withCurrentUser, ModalTrigger } from 'meteor/vulcan:core';
    ...
    <Dropdown id="user-dropdown">
      ...
      <Dropdown.Menu>
        ...
        <LinkContainer to={`/account`}>
         ...
         {currentUser.isAdmin ? 
          <ModalTrigger component={<MenuItem className="dropdown-item">Add category</MenuItem>}>
            <Components.CategoriesNewForm/>
          </ModalTrigger>
          : null}
          {currentUser.isAdmin ? <LinkContainer to={`/admin`}>
            <MenuItem className="dropdown-item" eventKey="2">Admin</MenuItem>
          </LinkContainer>
          : null}
          {currentUser.isAdmin ? <LinkContainer to={`/?view=pending`}>
          <MenuItem className="dropdown-item" eventKey="2">Pending</MenuItem>
          </LinkContainer>
          : null}
          {currentUser.isAdmin ? <LinkContainer to={`/?view=rejected`}>
          <MenuItem className="dropdown-item" eventKey="2">Rejected</MenuItem>
          </LinkContainer>
          : null}
          {currentUser.isAdmin ? <LinkContainer to={`/?view=scheduled`}>
          <MenuItem className="dropdown-item" eventKey="2">Scheduled</MenuItem>
          </LinkContainer>
          : null}
